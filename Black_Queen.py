...
def hit_or_stand(deck, hand):
    ...
    while True:
        ...
        if x == 'h':
            ...
            print('Player wants to stand dealers turn')
            playing = False
        else:
            print('I dont understand,Please enter h, or s')
            continue
        break
# show some or all cards
